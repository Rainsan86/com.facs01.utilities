...
namespace FACS01.Utilities
{
    ...
    {
        private const string RichToolName = Logger.ToolTag + "[快速拍照]" + Logger.EndTag;
        ...
        public void TakePhoto()
        {
            ...
            {
                fileName = EditorUtility.SaveFilePanel($"FACS快速拍照 - 保存新照片", "", "", "png");
            ...
            try
            {
                ...
                Logger.Log($"{RichToolName} <color=green>新照片已保存至：</color> {fileName}");
            }
